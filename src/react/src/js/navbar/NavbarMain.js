          ...
          <Navbar light expand='md'>
            ...
            <Collapse isOpen={this.state.isOpen} navbar>
              <Nav navbar>
                ...
                <NavItem className={(a_link === 'arindhal') ? 'active' : ''}>
                  <NavLink href='/arindhal' >Project Arindhal</NavLink>
                </NavItem>

                <NavItem className={(a_link === 'blog') ? 'active' : ''}>
                ...
                <NavItem className={(a_link === 'twm') ? 'active' : ''}>
                  <NavLink href='/twm' >Weather Monitor</NavLink>
                </NavItem>
