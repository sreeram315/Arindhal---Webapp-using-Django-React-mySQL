          ...
          <div className='container-fluid px-5'>
            ...
            <Row className='py-5'>
              ...
              <Col md={{ size: 8, order: 1 }} xs={{ size: 12, order: 2 }} sm={{ size: 12, order: 2 }} className='px-5'>
                ...
                {tweets !== undefined && tweets !== null && tweets.results !== undefined ? <TweetList tweets={tweets.results} fetchMoreTweets={this.fetchMoreTweets} noMoreTweets={noMoreTweets} refresh={this.refresh}/> : <div className='pt-5 al_re blog_spinner'><div className='spinner-grow text-primary spinner_big' role='status'>
