    ...
    return (
      ...
      <div className='each_blog'>
        <div class='border rounded pl-3 shadow p-3 mb-5 bg-white rounded'>
          ...
          <a className='no_dec' href={`/blog/${this.props.blog.slug}`} className='no_dec'>
          ...
          <Row><Col md={{ size: contSize }} sm={{ size: 12 }}><footer class='blockquote-footer ar_re'><cite title='Source Title'> {blog.date_created}</cite></footer></Col></Row>
        </div>
